...
inline int CPPR::D_el() const { return _D_el; }

// Function: D_rf
// Return the rf status of the test.
inline int CPPR::D_rf() const { return _D_rf; }

// Function: _decode_rf
// Return the transition of the given idx.
inline int CPPR::_decode_rf(int_t idx) const { return idx < _num_indices ? RISE : FALL; }

// Function: _encode_idx
inline int_t CPPR::_encode_idx(int rf, int_t idx) const { return rf == RISE ? idx : idx + _num_indices; }

// Function: _decode_idx
inline int_t CPPR::_decode_idx(int_t idx) const { return idx % _num_indices; }

// Function: _decode_node_ptr
inline node_pt CPPR::_decode_node_ptr(int_t idx) const { return (*_nodeset_ptr)[_decode_idx(idx)]; }

// Function: CK_rf
// Query the clock transition status.
inline int_t CPPR::CK_rf() const { return _CK_rf; }

// Function: test_ptr
// Return the pointer to the test.
inline test_pt CPPR::test_ptr() const { return _test_ptr; }

// Procedure: set_cutoff_slack
// Set the cutoff slack.
inline void_t CPPR::set_cutoff_slack(float_ct val) { _cutoff_slack = val; }

// Function: num_paths
// Return the number of ranked paths.
inline size_t CPPR::num_paths() const { return _prfx->size(); }
...
inline node_pt CPPR::through_node_ptr() const { return _through_node_ptr; }

// Function: D
// Return the D pin node.
inline node_pt CPPR::D() const { return _D; }

// Function: CK
// Return the CK pin node.
inline node_pt CPPR::CK() const { return _CK; }

// Function: S_idx
// Return the idx of the super source.
inline int_t CPPR::S_idx() const { return _S_idx; }

// Function: nodeset_ptr
// Return the pointer to the node set.
inline nodeset_pt CPPR::nodeset_ptr() const { return _nodeset_ptr; }

// Function: nodeset
// Return the reference to the node set.
inline nodeset_rt CPPR::nodeset() const { return *_nodeset_ptr; }

// Function: clock_tree_ptr
// Return the pointer to the clock tree.
inline clock_tree_pt CPPR::clock_tree_ptr() const { return _clock_tree_ptr; }

// Function: cutoff_slack
// Return the cutoff slack.
inline float_t CPPR::cutoff_slack() const { return _cutoff_slack; }
...
inline int_t PathPrefix::from_idx() const { return _from_idx; }

// Function: to_explorer
inline int_t PathPrefix::to_idx() const { return _to_idx; }

// Function: cppr_credit
// Query the cppr credit.
inline float_t PathPrefix::cppr_credit() const { return _cppr_credit; }

// Function: devi_credit
// Query the post cppr devi_credit.
inline float_t PathPrefix::devi_credit() const { return _devi_credit; }

// Function: deviator
// Query the deviator.
inline edge_pt PathPrefix::deviator() const { return _deviator; }

// Function: parent
// Query the parent of the path prefix.
inline path_prefix_pt PathPrefix::parent() const { return _parent; }

// Procedure: set_from_idx
// Set the from explorer
inline void_t PathPrefix::set_from_idx(int_t idx) { _from_idx = idx; }

// Procedure: set_to_idx
// Set the to explorer
inline void_t PathPrefix::set_to_idx(int_t idx) { _to_idx = idx; }

// Procedure: set_cppr_credit
// Set the cppr credit.
inline void_t PathPrefix::set_cppr_credit(float_ct credit) { _cppr_credit = credit; }

// Procedure: set_devi_credit
// Set the post cppr devi_credit.
inline void_t PathPrefix::set_devi_credit(float_ct devi_credit) { _devi_credit = devi_credit; }

// Procedure: set_parent
// Set the parent.
inline void_t PathPrefix::set_parent(path_prefix_pt parent) { _parent = parent; }

// Procedure: set_deviator
// Set the deviator.
inline void_t PathPrefix::set_deviator(edge_pt e) { _deviator = e; }
...
inline size_t PrefixHeap::size() const { return _N; }
...
inline int PathTrace::el() const { return _el; }

// Function: rf
// Query the timing trans.
inline int PathTrace::rf() const { return _rf; }

// Function: size
// Return the size of the trace.
inline size_t PathTrace::size() const { return _trace.size(); }

// Function: path_type
// Return the path type.
inline path_type_e PathTrace::path_type() const { return _path_type; }

// Procedure: set_el
// Set the timing split.
inline void_t PathTrace::set_el(int el) { _el = el; }

// Procedure: set_rf
// Set the timing trans.
inline void_t PathTrace::set_rf(int rf) { _rf = rf; }

// Procedure: set_slack
// Set the path slack.
inline void_t PathTrace::set_slack(float_ct slack) { _slack = slack; }

// Procedure: set_path_type
// Set the path type.
inline void_t PathTrace::set_path_type(path_type_ce type) { _path_type = type; }

// Procedure: clear
// Clear the trace.
inline void_t PathTrace::clear() { _trace.clear(); }

// Procedure: push_back
// Insert an idx into the trace.
inline void_t PathTrace::push_back(explorer_crt explorer) { _trace.push_back(explorer); }

// Function: slack
// Query the slack value.
inline float_t PathTrace::slack() const { return _slack; }

// Function: begin
// Return the begin position.
inline path_trace_iter_t PathTrace::begin() { return _trace.begin(); }

// Function: end
// Return the end position.
inline path_trace_iter_t PathTrace::end() { return _trace.end(); }

// Function: rbegin
// Return the reversed beging position.
inline path_trace_riter_t PathTrace::rbegin() { return _trace.rbegin(); }

// Function: rend
// Return the reversed ending position.
inline path_trace_riter_t PathTrace::rend() { return _trace.rend(); }
...
inline size_t PathTraceMinMaxHeap::size() const { return _N; }

// Function: top_min
inline path_trace_pt PathTraceMinMaxHeap::top_min() const { return (_N >= 1) ? _heap[1] : NULL; }
